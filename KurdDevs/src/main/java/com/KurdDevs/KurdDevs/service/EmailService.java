    ...
    public void sendActivationEmail(String recipientEmail, String activationToken) {
        ...
        try {
            ...
            String emailText = "<html><body>"
                    ...
                    + "<a href=\"https://kurddevs.onrender.com/activate?activationToken=" + URLEncoder.encode(activationToken, StandardCharsets.UTF_8) + "\">https://kurddevs.onrender.com/activate?activationToken=\" + URLEncoder.encode(activationToken, StandardCharsets.UTF_8)</a>"
